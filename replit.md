...
- June 26, 2025: Removed "Type" field from PDF downloads to clean up invoice presentation; enhanced PDF styling for maximum print contrast by removing gray backgrounds, using white backgrounds with thick black borders (4-5px), Arial Black fonts for all headings, and ultra-bold font weights (900) throughout for professional black and white printing
