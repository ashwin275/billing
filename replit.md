...
- June 25, 2025: Completed invoice tax display system - added CGST/SGST columns per item for informational purposes only; tax amounts calculated and displayed but not added to grand total; clear "Info Only" labeling; default payment status set to "PAID"; removed "Type" field from invoice sections
