...
- June 28, 2025: Fixed invoice preview and download showing incorrect customer data in Invoice Management - replaced hardcoded "Walk-in Customer" and placeholder text with actual customer names from API response (customerName field); updated both invoice-management.tsx and invoice-management-clean.tsx components; shop GST number and phone information already displaying correctly in PDF headers; customer location properly shows shop place from API data
