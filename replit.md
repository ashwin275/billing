...
- July 25, 2025: Added invoice date selection functionality to Create Invoice page - replaced hardcoded today's date with editable date input field that defaults to today but allows user to select any date; added invoiceDate field to form schema, API payload, and InvoiceInput type; updated both Create Invoice and Edit Invoice pages to handle invoice date properly; invoice date is now passed to backend API and displayed correctly in all invoice templates and PDFs
